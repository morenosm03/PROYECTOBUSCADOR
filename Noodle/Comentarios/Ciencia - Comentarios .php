...
<body>
    <div class="top-buttons">
        <button class="left-button hvr-underline-from-center" onclick="window.location.href='../Recursos/Ciencia.php'">
    ...
    <div class="container animate__animated animate__bounceInUp">
        <div class="header">
            <h2>Explorando los Descubrimientos Más Recientes</h2> 
        </div>
        <div class="header">
            <h1>Comentarios</h1>
