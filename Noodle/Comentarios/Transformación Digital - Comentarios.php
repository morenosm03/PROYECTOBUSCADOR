...
<body>
    <div class="top-buttons">
        <button class="left-button hvr-underline-from-center" onclick="window.location.href='../Recursos/Transformación Digital.php'">
    ...
    <div class="container animate__animated animate__bounceInUp">
        <div class="header">
            <h2>Transformación Digital - Informe y documento</h2> 
        </div>
        <div class="header">
            <h1>Comentarios</h1>
