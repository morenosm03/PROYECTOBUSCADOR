...
<body>
    <div class="top-buttons">
        <button class="left-button hvr-underline-from-center" onclick="window.location.href='../Recursos/Revoluciones Científicas.php'">
    ...
    <div class="container animate__animated animate__bounceInUp">
        <div class="header">
            <h2>Transformaciones en la Comprensión Científica del Mundo</h2> 
        </div>
        <div class="header">
            <h1>Comentarios</h1>
