...
<body>
    <div class="top-buttons">
        <button class="left-button hvr-underline-from-center" onclick="window.location.href='../Recursos/Biodiversidad - Adaptación.php'">
    ...
    <div class="container animate__animated animate__bounceInUp">
        <div class="header">
            <h2>Conservación y Resiliencia: La Importancia de la Biodiversidad y Adaptación en Ecosistemas Urbanos
            </h2> 
        </div>
        <div class="header">
            <h1>Comentarios</h1>
