...
<body>
    <div class="top-buttons">
        <button class="left-button hvr-underline-from-center" onclick="window.location.href='../Recursos/La Red de Redes.php'">
    ...
    <div class="container animate__animated animate__bounceInUp">
        <div class="header">
            <h2>La Red de Redes que conecta al mundo</h2> 
        </div>
        <div class="header">
            <h1>Comentarios</h1>
