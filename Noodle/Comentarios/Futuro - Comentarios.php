...
<body>
    <div class="top-buttons">
        <button class="left-button hvr-underline-from-center" onclick="window.location.href='../Recursos/Futuro.php'">
            <img src="../img/imagenes-generales/BackButton.png" alt="Volver">
        </button>
        <button class="right-button hvr-underline-from-center">LogOut</button>
    </div>
    <div class="container animate__animated animate__bounceInUp">
        <div class="header">
            <h2>Innovación Tecnológica y su Impacto en el Futuro</h2> 
        </div>
        <div class="header">
            <h1>Comentarios</h1>
